...
'Define variables.
 ...
 cachePath = "C:\Program Files\Registry_Monitor\"
...
Function createEmail()
  ...
  oFile.Write "To: " & toEmail & vbNewLine & "From: " & strComputerName & "@" & companyDomain & vbNewLine & _
   ...
   "This is an automatic email from the " & companyName & " Network to notify you that the registry was changed on a domain workstation." & _
...
Function sendEmail() 
  objShell.run "c:\Windows\System32\cmd.exe /c " & RNappPath & "sendmail.exe " & RNmailFile, 0, TRUE
End Function
' --------------------------------------------------
